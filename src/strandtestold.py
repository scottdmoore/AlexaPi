...
def sunrise(strip, total_time):
    ...
    for j in range(resolution):
            ...
            if j < divisor:
              ...
              rinc = ((53.0-5.0)/ divisor)
            elif j < divisor * 3:
              binc = (53.0 - 0.0)/ divisor * -1
            elif j < divisor * 4:
              rinc = (250.0-53)/ divisor
              #ginc = (131.0 - 0) / divisor
              #binc = (17.0 - 0) / divisor
            else:
              rinc = (250.0 - 250) / divisor
              ginc = (200.0 - 0) / divisor
              #binc = (240.0 - 0) / divisor
            newcolor = {}
